...
##          (socket: int, data: bytes)
##          socket's current data so we can select data with incoming socket id after write to db on server side.    
##          Selected data is served to client
##